...
> ssh -F ssh_config -i ~/cephadm_private_key {self.ssh_user}@{addr}'''
    ...
    def node_proxy_summary(self, hostname: Optional[str] = None) -> str:
        return self.node_proxy.summary(hostname)

    def node_proxy_firmware(self, hostname: Optional[str] = None) -> str:
        return self.node_proxy.firmware(hostname)

    def node_proxy_criticals(self, hostname: Optional[str] = None) -> str:
        return self.node_proxy.criticals(hostname)

    def node_proxy_common(self, category: str, hostname: Optional[str] = None) -> str:
        return self.node_proxy.common(category, hostname)
