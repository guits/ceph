...
class NodeProxyCache:
    ...
    def get_critical_from_host(self, hostname: str) -> Dict[str, Any]:
        ...
        for component, data_component in self.data[hostname]['status'].items():
            if not component in results.keys():
                results[component] = {}
        ...
        self.mgr.log.info(f"guits-debug2: {results}")
        return results

    def criticals(self, **kw) -> List[Dict[str, Any]]:
        """
